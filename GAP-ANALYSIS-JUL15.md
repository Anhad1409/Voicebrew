...
- Remaining nice-to-haves: voice-playground Save Config + max-tokens slider parity · learning-lab sweep builder detail · specialized channel sheets (Truecaller/WhatsApp/SMS fields) · live-drive crawl of original (blocked on Chrome "Allow JavaScript from Apple Events" + Screen Recording permission)
